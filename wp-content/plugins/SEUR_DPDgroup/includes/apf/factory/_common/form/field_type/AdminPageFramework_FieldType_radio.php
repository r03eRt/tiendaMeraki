...
class SEUR_AdminPageFramework_FieldType_radio extends SEUR_AdminPageFramework_FieldType {
    public $aFieldTypeSlugs = array('radio');
    protected $aDefaultKeys = array('label' => array(), 'attributes' => array(),);
    protected function getStyles() {
        return ".seur-field input[type='radio'] {margin-right: 0.5em;} .seur-field-radio .seur-input-label-container {padding-right: 1em;} .seur-field-radio .seur-input-container {display: inline;} .seur-field-radio .seur-input-label-string{display: inline; }";
    }
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).change( function() {
        ...
        jQuery( this ).closest( '.seur-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' ).attr( 'checked', false );
