...
class SEUR_AdminPageFramework_FieldType_taxonomy extends SEUR_AdminPageFramework_FieldType_checkbox {
    ...
    protected function setUp() {
        new SEUR_AdminPageFramework_Form_View___Script_CheckboxSelector;
    }
    protected function getScripts() {
        $_aJSArray = json_encode($this->aFieldTypeSlugs);
        return parent::getScripts() . <<<JAVASCRIPTS
/* For tabs */
var enableSEUR_AdminPageFrameworkTabbedBox = function( nodeTabBoxContainer ) {
...
jQuery( document ).ready( function() {
    ...
    enableSEUR_AdminPageFrameworkTabbedBox( jQuery( '.tab-box-container' ) );
    ...
    jQuery().registerSEUR_AdminPageFrameworkCallbacks( {
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            // Initialize
            enableSEUR_AdminPageFrameworkTabbedBox( oCloned.find( '.tab-box-container' ) );
...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".seur-field .taxonomy-checklist li { margin: 8px 0 8px 20px; }.seur-field div.taxonomy-checklist {padding: 8px 0 8px 10px;margin-bottom: 20px;}.seur-field .taxonomy-checklist ul {list-style-type: none;margin: 0;}.seur-field .taxonomy-checklist ul ul {margin-left: 1em;}.seur-field .taxonomy-checklist-label {white-space: nowrap; }.seur-field .tab-box-container.categorydiv {max-height: none;}.seur-field .tab-box-tab-text {display: inline-block;font-size: 13px;font-size: smaller;padding: 2px;}.seur-field .tab-box-tabs {line-height: 12px;margin-bottom: 0;}.seur-field .tab-box-tabs .tab-box-tab.active {display: inline;border-color: #dfdfdf #dfdfdf #fff;margin-bottom: 0px;padding-bottom: 4px;background-color: #fff;}.seur-field .tab-box-container { position: relative; width: 100%; clear: both;margin-bottom: 1em;}.seur-field .tab-box-tabs li a { color: #333; text-decoration: none; }.seur-field .tab-box-contents-container {padding: 0 0 0 1.8em;padding: 0.55em 0.5em 0.55em 1.8em;border: 1px solid #dfdfdf; background-color: #fff;}.seur-field .tab-box-contents { overflow: hidden; overflow-x: hidden; position: relative; top: -1px; height: 300px;}.seur-field .tab-box-content { display: none; overflow: auto; display: block; position: relative; overflow-x: hidden;}.seur-field .tab-box-content .taxonomychecklist {margin-right: 3.2em;}.seur-field .tab-box-content:target, .seur-field .tab-box-content:target, .seur-field .tab-box-content:target { display: block; }.seur-field .tab-box-content .select_all_button_container, .seur-field .tab-box-content .select_none_button_container{display: inline-block;margin-top: 0.8em;}.seur-field .taxonomychecklist .children {margin-top: 6px;margin-left: 1em;}";
    }
