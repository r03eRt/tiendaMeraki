...
class SEUR_AdminPageFramework_Form_View___Description extends SEUR_AdminPageFramework_FrameworkUtility {
    public $aDescriptions = array();
    public $sClassAttribute = 'seur-form-element-description';
