...
class SEUR_AdminPageFramework_Form_View___Generate_FieldTagID extends SEUR_AdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
...
class SEUR_AdminPageFramework_Form_View___Generate_FieldInputID extends SEUR_AdminPageFramework_Form_View___Generate_FieldTagID {
    public $isIndex = '';
