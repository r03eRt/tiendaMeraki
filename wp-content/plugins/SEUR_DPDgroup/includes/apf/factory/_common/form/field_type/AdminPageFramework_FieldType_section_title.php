...
class SEUR_AdminPageFramework_FieldType_section_title extends SEUR_AdminPageFramework_FieldType_text {
    ...
    protected function getStyles() {
        return ".seur-section-tab .seur-field-section_title {padding: 0.5em;} .seur-section-tab .seur-field-section_title .seur-input-label-string { vertical-align: middle; margin-left: 0.2em;}.seur-section-tab .seur-fields {display: inline-block;} .seur-field.seur-field-section_title {float: none;} .seur-field.seur-field-section_title input {background-color: #fff;color: #333;border-color: #ddd;box-shadow: inset 0 1px 2px rgba(0,0,0,.07);border-width: 1px;border-style: solid;outline: 0;box-sizing: border-box;vertical-align: middle;}";
    }
