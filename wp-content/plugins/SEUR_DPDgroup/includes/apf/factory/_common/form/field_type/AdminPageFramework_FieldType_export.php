...
class SEUR_AdminPageFramework_FieldType_submit extends SEUR_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".seur-field input[type='submit'] {margin-bottom: 0.5em;}";
    }
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] || '0' === ( string )$aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'seur-input-label-container' . ' seur-input-button-container' . ' seur-input-container',);
    }
...
class SEUR_AdminPageFramework_FieldType_export extends SEUR_AdminPageFramework_FieldType_submit {
