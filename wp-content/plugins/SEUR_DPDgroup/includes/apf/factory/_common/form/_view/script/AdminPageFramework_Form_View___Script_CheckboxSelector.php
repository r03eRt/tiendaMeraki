...
class SEUR_AdminPageFramework_Form_View___Script_CheckboxSelector extends SEUR_AdminPageFramework_Form_View___Script_Base {
...
(function ( $ ) {
     ...
     */        
    $.fn.selectAllSEUR_AdminPageFrameworkCheckboxes = function() {
        jQuery( this ).parent()
     ...
     */
    $.fn.deselectAllSEUR_AdminPageFrameworkCheckboxes = function() {
        jQuery( this ).parent()
            .find( 'input[type=checkbox]' )
            .attr( 'checked', false )
            .trigger( 'change' );   // 3.8.8+
