...
class SEUR_AdminPageFramework_Form_View___Script_SortableField extends SEUR_AdminPageFramework_Form_View___Script_Base {
    ...
    static public function getScript() {
        return <<<JAVASCRIPTS
(function($) {
    $.fn.enableSEUR_AdminPageFrameworkSortableFields = function( sFieldsContainerID ) {
...
class SEUR_AdminPageFramework_Form_View___Script_SortableSection extends SEUR_AdminPageFramework_Form_View___Script_SortableField {
    static public function getScript() {
        return <<<JAVASCRIPTS
(function($) {
    $.fn.enableSEUR_AdminPageFrameworkSortableSections = function( sSectionsContainerID ) {
        ...
        var _bIsTabbed      = _oTarget.hasClass( 'seur-section-tabs-contents' );
        var _bCollapsible   = 0 < _oTarget.children( '.seur-section.is_subsection_collapsible' ).length;

        var _oTarget        = _bIsTabbed
            ? _oTarget.find( 'ul.seur-section-tabs' )
            : _oTarget;
        ...
        var _aSortableOptions = { 
                items: _bIsTabbed
                    ? '> li:not( .disabled )'
                    : '> div:not( .disabled, .seur-collapsible-toggle-all-button-container )', 
                handle: _bCollapsible
                    ? '.seur-section-caption'
                    : false,
                ...
                // cancel: '.seur-section-description, .seur-section-title'
        ...
        if ( ! _bIsTabbed ) {
            ...
            _oSortable.bind( 'sortstop', function() {
                ...
                jQuery( this ).find( 'caption > .seur-section-title:not(.seur-collapsible-sections-title,.seur-collapsible-section-title)' ).first().show();
                jQuery( this ).find( 'caption > .seur-section-title:not(.seur-collapsible-sections-title,.seur-collapsible-section-title)' ).not( ':first' ).hide();
...
jQuery( document ).ready( function() {    
    jQuery( '#{$sContainerTagID}' ).enableSEUR_AdminPageFrameworkSortableSections( '{$sContainerTagID}' ); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='seur-section-sortable-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}
