...
class SEUR_AdminPageFramework_Form_View___CSS_CollapsibleSectionIE extends SEUR_AdminPageFramework_Form_View___CSS_Base {
    protected function _get() {
        return $this->_getCollapsibleSectionsRules();
    }
    private function _getCollapsibleSectionsRules() {
        return "tbody.seur-collapsible-content > tr > th,tbody.seur-collapsible-content > tr > td{padding-right: 20px;padding-left: 20px;}";
    }
}
