...
class SEUR_AdminPageFramework_Form_Model___SetFieldResources extends SEUR_AdminPageFramework_Form_Base {
    ...
    private function ___setCommon() {
        ...
        new SEUR_AdminPageFramework_Form_View___Script_RegisterCallback;
        $this->___setCommonFormInternalCSSRules();
    }
    private function ___setCommonFormInternalCSSRules() {
        $_aClassNames = array('SEUR_AdminPageFramework_Form_View___CSS_Form', 'SEUR_AdminPageFramework_Form_View___CSS_Field', 'SEUR_AdminPageFramework_Form_View___CSS_Section', 'SEUR_AdminPageFramework_Form_View___CSS_CollapsibleSection', 'SEUR_AdminPageFramework_Form_View___CSS_FieldError', 'SEUR_AdminPageFramework_Form_View___CSS_ToolTip',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
            $this->aResources['internal_styles'][] = $_oCSS->get();
        }
        $_aClassNamesForIE = array('SEUR_AdminPageFramework_Form_View___CSS_CollapsibleSectionIE',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
    ...
    private function ___setFieldResourcesByFieldTypeDefinition($aFieldset, $_sFieldtype, $_aFieldTypeDefinition) {
        ...
        new SEUR_AdminPageFramework_Form_Model___FieldTypeRegistration($_aFieldTypeDefinition, $this->aArguments['structure_type']);
        $_oFieldTypeResources = new SEUR_AdminPageFramework_Form_Model___FieldTypeResource($_aFieldTypeDefinition, $this->aResources);
