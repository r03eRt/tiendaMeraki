...
class SEUR_AdminPageFramework_Form_View___DebugInfo extends SEUR_AdminPageFramework_FrameworkUtility {
    ...
    public function get() {
        ...
        return "<div class='seur-info'>" . $this->oMsg->get('debug_info') . ': ' . $this->getFrameworkNameVersion() . "</div>";
    }
