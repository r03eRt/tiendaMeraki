...
class SEUR_AdminPageFramework_FieldType_import extends SEUR_AdminPageFramework_FieldType_submit {
    ...
    protected function getStyles() {
        return ".seur-field-import input {margin-right: 0.5em;}.seur-field-import label,.form-table td fieldset.seur-fieldset .seur-field-import label { display: inline; }";
    }
