...
class SEUR_AdminPageFramework_Form_View___Script_SectionTab extends SEUR_AdminPageFramework_Form_View___Script_Base {
...
jQuery( '.seur-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='seur-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}
