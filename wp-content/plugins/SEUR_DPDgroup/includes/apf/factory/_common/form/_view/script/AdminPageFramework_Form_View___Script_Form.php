...
class SEUR_AdminPageFramework_Form_View___Script_Form extends SEUR_AdminPageFramework_Form_View___Script_Base {
    static public function getScript() {
        return <<<JAVASCRIPTS
( function( $ ) {

    var _removeSEUR_AdminPageFrameworkLoadingOutputs = function() {

        jQuery( '.seur-form-loading' ).remove();
        jQuery( '.seur-form-js-on' )
            .hide()
            .css( 'visibility', 'visible' )
            .fadeIn( 200 )
            .removeClass( '.seur-form-js-on' );
    ...
    window.onerror = function(){
        ...
        _removeSEUR_AdminPageFrameworkLoadingOutputs();
