...
class SEUR_AdminPageFramework_Form_View___Script_MediaUploader extends SEUR_AdminPageFramework_Form_View___Script_Base {
...
(function ( $ ) {
    ...
    getSEUR_AdminPageFrameworkCustomMediaUploaderSelectObject = function() {
