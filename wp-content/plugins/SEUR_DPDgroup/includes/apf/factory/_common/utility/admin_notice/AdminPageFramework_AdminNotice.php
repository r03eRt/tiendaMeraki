...
class SEUR_AdminPageFramework_AdminNotice extends SEUR_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes = array('class' => 'error'), array $aCallbacks = array()) {
        ...
        $this->aAttributes['class'] = $this->getClassAttribute($this->aAttributes['class'], 'seur-settings-notice-message', 'seur-settings-notice-container', 'notice', 'is-dismissible');
        $this->aCallbacks = $aCallbacks + $this->aCallbacks;
        new SEUR_AdminPageFramework_AdminNotice___Script;
        if (!$sNotice) {
            return;
        }
