...
class SEUR_AdminPageFramework_WPUtility_URL extends SEUR_AdminPageFramework_Utility {
    ...
    static public function getQueryAdminURL($aAddingQueries = array(), $aRemovingQueryKeys = array(), $sSubjectURL = '') {
        $_sAdminURL = is_network_admin() ? network_admin_url(SEUR_AdminPageFramework_WPUtility_Page::getPageNow()) : admin_url(SEUR_AdminPageFramework_WPUtility_Page::getPageNow());
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        $_sRelativePath = SEUR_AdminPageFramework_Utility::getRelativePath(ABSPATH, $sFilePath);
...
class SEUR_AdminPageFramework_WPUtility_HTML extends SEUR_AdminPageFramework_WPUtility_URL {
...
class SEUR_AdminPageFramework_WPUtility_Page extends SEUR_AdminPageFramework_WPUtility_HTML {
...
class SEUR_AdminPageFramework_WPUtility_Hook extends SEUR_AdminPageFramework_WPUtility_Page {
...
class SEUR_AdminPageFramework_WPUtility_File extends SEUR_AdminPageFramework_WPUtility_Hook {
...
class SEUR_AdminPageFramework_WPUtility_Option extends SEUR_AdminPageFramework_WPUtility_File {
...
class SEUR_AdminPageFramework_WPUtility_Meta extends SEUR_AdminPageFramework_WPUtility_Option {
...
class SEUR_AdminPageFramework_WPUtility_SiteInformation extends SEUR_AdminPageFramework_WPUtility_Meta {
...
class SEUR_AdminPageFramework_WPUtility_SystemInformation extends SEUR_AdminPageFramework_WPUtility_SiteInformation {
...
class SEUR_AdminPageFramework_WPUtility extends SEUR_AdminPageFramework_WPUtility_SystemInformation {
