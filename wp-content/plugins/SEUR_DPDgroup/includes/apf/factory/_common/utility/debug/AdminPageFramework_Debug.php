...
class SEUR_AdminPageFramework_Debug_Base extends SEUR_AdminPageFramework_FrameworkUtility {
...
class SEUR_AdminPageFramework_Debug_Log extends SEUR_AdminPageFramework_Debug_Base {
...
class SEUR_AdminPageFramework_Debug extends SEUR_AdminPageFramework_Debug_Log {
    ...
    static public function dumpArray($asArray, $sFilePath = null) {
        self::showDeprecationNotice('SEUR_AdminPageFramework_Debug::' . __FUNCTION__, 'SEUR_AdminPageFramework_Debug::dump()');
        SEUR_AdminPageFramework_Debug::dump($asArray, $sFilePath);
    }
    static public function getArray($asArray, $sFilePath = null, $bEscape = true) {
        self::showDeprecationNotice('SEUR_AdminPageFramework_Debug::' . __FUNCTION__, 'SEUR_AdminPageFramework_Debug::get()');
        return SEUR_AdminPageFramework_Debug::get($asArray, $sFilePath, $bEscape);
    }
    static public function logArray($asArray, $sFilePath = null) {
        self::showDeprecationNotice('SEUR_AdminPageFramework_Debug::' . __FUNCTION__, 'SEUR_AdminPageFramework_Debug::log()');
        SEUR_AdminPageFramework_Debug::log($asArray, $sFilePath);
    }
    static public function getAsString($mValue) {
        self::showDeprecationNotice('SEUR_AdminPageFramework_Debug::' . __FUNCTION__);
