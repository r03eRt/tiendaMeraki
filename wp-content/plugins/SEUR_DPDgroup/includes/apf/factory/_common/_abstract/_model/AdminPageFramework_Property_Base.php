...
abstract class SEUR_AdminPageFramework_Property_Base extends SEUR_AdminPageFramework_FrameworkUtility {
    ...
    private function ___setProperties($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'seur' : $sTextDomain;
    ...
    private function ___setGlobals() {
        if (!isset($GLOBALS['aSEUR_AdminPageFramework'])) {
            $GLOBALS['aSEUR_AdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => SEUR_AdminPageFramework_Registry::NAME, 'sURI' => SEUR_AdminPageFramework_Registry::URI, 'sScriptName' => SEUR_AdminPageFramework_Registry::NAME, 'sLibraryName' => SEUR_AdminPageFramework_Registry::NAME, 'sLibraryURI' => SEUR_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => SEUR_AdminPageFramework_Registry::getVersion(), 'sDescription' => SEUR_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => SEUR_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => SEUR_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => SEUR_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => SEUR_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new SEUR_AdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
}
