...
abstract class SEUR_AdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $oHelpPane;
    protected $oLink;
    protected $_aSubClassPrefixes = array('oForm' => 'SEUR_AdminPageFramework_Form_', 'oPageLoadInfo' => 'SEUR_AdminPageFramework_PageLoadInfo_', 'oResource' => 'SEUR_AdminPageFramework_Resource_', 'oHelpPane' => 'SEUR_AdminPageFramework_HelpPane_', 'oLink' => 'SEUR_AdminPageFramework_Link_',);
    private $_aSubClassNames = array('oProp' => null, 'oDebug' => 'SEUR_AdminPageFramework_Debug', 'oUtil' => 'SEUR_AdminPageFramework_FrameworkUtility', 'oMsg' => 'SEUR_AdminPageFramework_Message', 'oForm' => null, 'oPageLoadInfo' => null, 'oResource' => null, 'oHelpPane' => null, 'oLink' => null,);
    ...
    private function _triggerUndefinedMethodWarning($sMethodName) {
        trigger_error(SEUR_AdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
    public function __toString() {
        return SEUR_AdminPageFramework_FrameworkUtility::getObjectInfo($this);
    }
...
abstract class SEUR_AdminPageFramework_Factory_Model extends SEUR_AdminPageFramework_Factory_Router {
    public function __construct($oProp) {
...
abstract class SEUR_AdminPageFramework_Factory_View extends SEUR_AdminPageFramework_Factory_Model {
    public function __construct($oProp) {
        parent::__construct($oProp);
        new SEUR_AdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
    }
...
abstract class SEUR_AdminPageFramework_Factory_Controller extends SEUR_AdminPageFramework_Factory_View {
...
abstract class SEUR_AdminPageFramework_Factory extends SEUR_AdminPageFramework_Factory_Controller {
}
