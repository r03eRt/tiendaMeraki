...
abstract class SEUR_AdminPageFramework_PageMetaBox_Router extends SEUR_AdminPageFramework_MetaBox_View {
...
abstract class SEUR_AdminPageFramework_PageMetaBox_Model extends SEUR_AdminPageFramework_PageMetaBox_Router {
...
abstract class SEUR_AdminPageFramework_PageMetaBox_View extends SEUR_AdminPageFramework_PageMetaBox_Model {
}
abstract class SEUR_AdminPageFramework_PageMetaBox_Controller extends SEUR_AdminPageFramework_PageMetaBox_View {
...
abstract class SEUR_AdminPageFramework_PageMetaBox extends SEUR_AdminPageFramework_PageMetaBox_Controller {
    protected $_sStructureType = 'page_meta_box';
    public function __construct($sMetaBoxID, $sTitle, $asPageSlugs = array(), $sContext = 'normal', $sPriority = 'default', $sCapability = 'manage_options', $sTextDomain = 'seur') {
