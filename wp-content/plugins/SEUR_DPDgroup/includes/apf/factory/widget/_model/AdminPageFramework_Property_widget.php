...
class SEUR_AdminPageFramework_Property_widget extends SEUR_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'seur', $sStructureType) {
