...
abstract class SEUR_AdminPageFramework_UserMeta_Router extends SEUR_AdminPageFramework_Factory {
...
abstract class SEUR_AdminPageFramework_UserMeta_Model extends SEUR_AdminPageFramework_UserMeta_Router {
    public function _replyToGetSavedFormData() {
        $_iUserID = isset($GLOBALS['profileuser']->ID) ? $GLOBALS['profileuser']->ID : 0;
        $_oMetaData = new SEUR_AdminPageFramework_UserMeta_Model___UserMeta($_iUserID, $this->oForm->aFieldsets);
...
abstract class SEUR_AdminPageFramework_UserMeta_View extends SEUR_AdminPageFramework_UserMeta_Model {
...
abstract class SEUR_AdminPageFramework_UserMeta_Controller extends SEUR_AdminPageFramework_UserMeta_View {
...
abstract class SEUR_AdminPageFramework_UserMeta extends SEUR_AdminPageFramework_UserMeta_Controller {
    protected $_sStructureType = 'user_meta';
    public function __construct($sCapability = 'read', $sTextDomain = 'seur') {
