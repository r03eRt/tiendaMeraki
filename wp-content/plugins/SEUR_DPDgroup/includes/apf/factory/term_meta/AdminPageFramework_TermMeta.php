...
abstract class SEUR_AdminPageFramework_TermMeta_Router extends SEUR_AdminPageFramework_TaxonomyField_Controller {
}
abstract class SEUR_AdminPageFramework_TermMeta_Model extends SEUR_AdminPageFramework_TermMeta_Router {
    ...
    private function _getSavedTermMetas($iTermID, array $aFieldsets) {
        $_oMetaData = new SEUR_AdminPageFramework_TermMeta_Model___TermMeta($iTermID, $this->oForm->aFieldsets);
...
abstract class SEUR_AdminPageFramework_TermMeta_View extends SEUR_AdminPageFramework_TermMeta_Model {
...
abstract class SEUR_AdminPageFramework_TermMeta_Controller extends SEUR_AdminPageFramework_TermMeta_View {
}
abstract class SEUR_AdminPageFramework_TermMeta extends SEUR_AdminPageFramework_TermMeta_Controller {
    protected $_sStructureType = 'term_meta';
    public function __construct($asTaxonomySlug, $sCapability = 'manage_options', $sTextDomain = 'seur') {
