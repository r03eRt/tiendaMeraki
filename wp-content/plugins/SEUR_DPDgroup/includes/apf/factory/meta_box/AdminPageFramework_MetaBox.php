...
abstract class SEUR_AdminPageFramework_MetaBox_Router extends SEUR_AdminPageFramework_Factory {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'seur') {
...
abstract class SEUR_AdminPageFramework_MetaBox_Model extends SEUR_AdminPageFramework_MetaBox_Router {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'seur') {
    ...
    public function _replyToGetSavedFormData() {
        $_oMetaData = new SEUR_AdminPageFramework_MetaBox_Model___PostMeta($this->_getPostID(), $this->oForm->aFieldsets);
...
abstract class SEUR_AdminPageFramework_MetaBox_View extends SEUR_AdminPageFramework_MetaBox_Model {
...
abstract class SEUR_AdminPageFramework_MetaBox_Controller extends SEUR_AdminPageFramework_MetaBox_View {
...
abstract class SEUR_AdminPageFramework_MetaBox extends SEUR_AdminPageFramework_MetaBox_Controller {
