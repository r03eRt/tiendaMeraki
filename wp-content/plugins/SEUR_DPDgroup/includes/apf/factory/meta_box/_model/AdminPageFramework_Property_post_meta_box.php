...
class SEUR_AdminPageFramework_Property_post_meta_box extends SEUR_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'edit_posts', $sTextDomain = 'seur', $sStructureType = 'post_meta_box') {
