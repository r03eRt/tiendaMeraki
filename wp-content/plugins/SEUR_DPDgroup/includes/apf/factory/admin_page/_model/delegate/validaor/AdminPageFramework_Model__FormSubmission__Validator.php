...
class SEUR_AdminPageFramework_Model__FormSubmission__Validator_Base extends SEUR_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
...
class SEUR_AdminPageFramework_Model__FormSubmission__Validator extends SEUR_AdminPageFramework_Model__FormSubmission__Validator_Base {
    public $oFactory;
    ...
    public function _replyToValiateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
        ...
        $_aClassNames = array('SEUR_AdminPageFramework_Model__FormSubmission__Validator__Link', 'SEUR_AdminPageFramework_Model__FormSubmission__Validator__Redirect', 'SEUR_AdminPageFramework_Model__FormSubmission__Validator__Import', 'SEUR_AdminPageFramework_Model__FormSubmission__Validator__Export', 'SEUR_AdminPageFramework_Model__FormSubmission__Validator__Reset', 'SEUR_AdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'SEUR_AdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'SEUR_AdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
        ...
        try {
            ...
            $_oFormSubmissionFilter = new SEUR_AdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
