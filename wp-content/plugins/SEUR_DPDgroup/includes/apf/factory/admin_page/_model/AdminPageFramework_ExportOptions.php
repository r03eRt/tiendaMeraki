...
abstract class SEUR_AdminPageFramework_CustomSubmitFields extends SEUR_AdminPageFramework_FrameworkUtility {
    public $aPost = array();
    public $sInputID;
...
class SEUR_AdminPageFramework_ExportOptions extends SEUR_AdminPageFramework_CustomSubmitFields {
    public $sClassName;
    public $sFileName;
    public $sFormatType;
    public $bIsDataSet;
        ...
        switch (strtolower($sFormatType)) {
            case 'text':
                if (in_array(gettype($vData), array('array', 'object'))) {
                    echo SEUR_AdminPageFramework_Debug::get($vData, null, false);
                }
                echo $vData;
                return;
            case 'json':
