...
class SEUR_AdminPageFramework_Property_admin_page extends SEUR_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'seur') {
        ...
        $GLOBALS['aSEUR_AdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('aSEUR_AdminPageFramework', 'aPageClasses'));
        $GLOBALS['aSEUR_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
