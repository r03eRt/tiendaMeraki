...
class SEUR_AdminPageFramework_Form_taxonomy_field extends SEUR_AdminPageFramework_Form {
    ...
    public function get() {
        ...
        $_oFieldsets = new SEUR_AdminPageFramework_Form_View___FieldsetRows($this->getElementAsArray($this->aFieldsets, '_default'), null, $this->aSavedData, $this->getFieldErrors(), $this->aFieldTypeDefinitions, $this->aCallbacks, $this->oMsg);
