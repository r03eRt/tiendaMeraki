...
abstract class SEUR_AdminPageFramework_TaxonomyField_Router extends SEUR_AdminPageFramework_Factory {
...
abstract class SEUR_AdminPageFramework_TaxonomyField_Model extends SEUR_AdminPageFramework_TaxonomyField_Router {
...
abstract class SEUR_AdminPageFramework_TaxonomyField_View extends SEUR_AdminPageFramework_TaxonomyField_Model {
...
abstract class SEUR_AdminPageFramework_TaxonomyField_Controller extends SEUR_AdminPageFramework_TaxonomyField_View {
    public function setUp() {
    }
}
abstract class SEUR_AdminPageFramework_TaxonomyField extends SEUR_AdminPageFramework_TaxonomyField_Controller {
    protected $_sStructureType = 'taxonomy_field';
    function __construct($asTaxonomySlug, $sOptionKey = '', $sCapability = 'manage_options', $sTextDomain = 'seur') {
