...
abstract class SEUR_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('SEUR_AdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new SEUR_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
