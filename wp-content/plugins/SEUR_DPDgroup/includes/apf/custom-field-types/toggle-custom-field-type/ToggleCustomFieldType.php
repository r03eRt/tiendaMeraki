...
if ( ! class_exists( 'SEUR_ToggleCustomFieldType' ) ) :
/**
 ...
 */
class SEUR_ToggleCustomFieldType extends SEUR_AdminPageFramework_FieldType_checkbox {
        ...
        return "jQuery( document ).ready( function(){
            ...
            jQuery( '.switch_toggle_buttons' ).each( function () {
                ...
                jQuery( this ).closest( '.seur-field' )
                    .children( '.seur-checkbox-container-toggle' )
                    .hide();
