 ...
 * @package     SEUR_AdminPageFramework
 */

if ( ! class_exists( 'SEUR_Select2CustomFieldType' ) ) :
/**
 ...
 */
class SEUR_Select2CustomFieldType extends SEUR_AdminPageFramework_FieldType_select {
...
"jQuery( document ).ready( function(){
    ...
    var _initializeSelect2 = function( oNode ) {
        ...
        if ( _aOptions[ 'width' ] && 'auto' !== _aOptions[ 'width' ] ) {
            var _oFieldContainer = _oSelect2Target.closest( '.seur-field-select2' );
            _oFieldContainer.css( 'width', _aOptions[ 'width' ] );
            _oFieldContainer.children( '.seur-select-label' )
                .css( 'width', '100%' );
            _oFieldContainer.children( '.seur-select-label' )
                .children( 'label' )
                .children( '.seur-input-container' )
                .css( 'width', '100%' );
            _aOptions[ 'width' ] = '100%';
        }
        ...
        if ( _aOptions[ 'search_callback' ] ) {
             ...
             * Set inital values.
             */
            var _oInputForEncoded = _oSelect2Target.closest( '.seur-field' )
            ...
            _oSelect2Target.on( 'change', function( event ){
                ...
                jQuery( this ).closest( '.seur-field' )
                    .children( 'input[data-encoded]' ).first()
    ...
    jQuery().registerSEUR_AdminPageFrameworkCallbacks( {
        /**
    ...
    protected function getStyles() {
        return "
.seur-field-select2 .select2-container {     
    min-width: 200px;
    width: auto;
}
...
.repeatable .seur-field-select2 > .seur-select-label > label > .seur-input-container {
    max-width: 84%;
}
