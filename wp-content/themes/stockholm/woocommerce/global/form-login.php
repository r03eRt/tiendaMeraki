...
<form class="woocomerce-form woocommerce-form-login login check-login" method="post" <?php if ( $hidden ) echo 'style="display:none;"'; ?>>
	...
	<p class="form-row">
		...
		<input type="submit" class="button" name="login" value="<?php esc_attr_e( 'Login', 'qode' ); ?>" />
		<a class="lost_password" href="<?php echo esc_url( wp_lostpassword_url() ); ?>"><?php _e( 'Lost your password?', 'qode' ); ?></a>
